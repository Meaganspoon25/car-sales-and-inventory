...
```
{
	"first_name": "John",
	"last_name": "Doe",
	"address": ""5678 Essen Street, Houston, TX 77001",
...
```
{
	"customers": [
		...
		},
		{
			"first_name": "Jane",
			"last_name": "Doe",
			"address": "1234 Hollywood Ave, Austin, TX, 76588",
...
```
Delete Customer (SEND THIS URL  http://localhost:8090/api/customers/id/:)
```
```
...
Update Customer (SEND THIS JSON Body and this URL http://localhost:8090/api/customers/id/:)
```
{
	"first_name": "Sandra"
}
```
Return Value of updating a Customer:
```
{
	"id: "1",
	"first_name": "Sandra",
...
```
Delete a Salesperson (SEND THIS URL  http://localhost:8090/api/salespeople/id/:)
```
```
...
Update Salesperson (SEND THIS JSON Body and this URL http://localhost:8090/api/salespeople/id/:)
```
{
	"first_name": "Andrew"
}
```
Return Value of updating a Salesperson:
```
{
	"href": "/api/salespeople/1/",
	"first_name": "Andrew",
...
### Salesrecords:
- the id value to show a specific salesrecord is the **"id" value tied to a salesperson.**

| Action | Method | URL
| ----------- | ----------- | ----------- |
| List all salesrecords | GET | http://localhost:8090/api/sales/
| Create a new sale | POST | http://localhost:8090/api/sales/
| Show a salesrecord | GET | http://localhost:8090/api/sales/id/
| Delete a salesrecord | DELETE | http://localhost:8090/api/sales/id/
| Update a salesrecord | PUT | http://localhost:8090/api/sales/id/
	...
	"sales": [
		{
			"price": "23000.00",
			"automobile": {
				"import_href": "/api/automobiles/JHMSM3333BC171961/",
				"vin": "JHMSM3333BC171961",
				"sold": true,
				"id": 1
			},
			"salesperson": {
...
Delete a Sale (SEND THIS URL  http://localhost:8090/api/sales/id/:)
```
```
...
```
Update Sales (SEND THIS JSON Body and this URL http://localhost:8090/api/sales/id/:)
```
{
	"sold": "false"
}
```
Return Value of updating a Sale:
```
	"sales": [
		{
			"price": "23000.00",
...
## React Compents
Here we will explain how our React front-end components function.  We can break this down into four categories.
